      ...
      <div className="container mx-auto px-6 text-center">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="mt-6 text-lg md:text-xl text-slate-600">
            The platform for modern governance. Hold politicians accountable, shape policy, and participate in a more transparent democracy.
          </p>
          ...
          <div className="mt-20">
            <h2 className="text-2xl md:text-3xl font-bold text-slate-800 mb-6">How it works</h2>
